...
{
    public class CNHRMedicalProvidersController : Controller
    {
        private readonly ArchpointMvcPHRContext _context;

        public CNHRMedicalProvidersController(ArchpointMvcPHRContext context)
        {
            _context = context;
        }

        // GET: CNHRMedicalProviders
        public async Task<IActionResult> Index()
        {
            return View(await _context.MedicalProvider.ToListAsync());
        }

        // GET: CNHRMedicalProviders/Details/5
        ...
        // GET: CNHRMedicalProviders/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CNHRMedicalProviders/Create
        ...
        // GET: CNHRMedicalProviders/Edit/5
        ...
        // POST: CNHRMedicalProviders/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: CNHRMedicalProviders/Delete/5
        ...
        // POST: CNHRMedicalProviders/Delete/5
