...
namespace ArchpointMvcPHR.Controllers
{
    public class CaregiversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,MiddleName,Relationship,Address,City,State,ZipCode,Country,CellPhone,WorkPhone,Email")] Caregivers caregivers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,MiddleName,Relationship,Address,City,State,ZipCode,Country,CellPhone,WorkPhone,Email")] Caregivers caregivers)
        {
            if (id != caregivers.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CaregiversExists(caregivers.Id))
                    {
                        return NotFound();
                    }
                    else
