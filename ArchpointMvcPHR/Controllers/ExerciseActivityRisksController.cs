...
namespace ArchpointMvcPHR.Controllers
{
    public class ExerciseActivityRisksController : Controller
    {
        ...
        public ExerciseActivityRisksController(ArchpointMvcPHRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var exerciseActivityRisk = await _context.ExerciseActivityRisk
                .FirstOrDefaultAsync(m => m.ExerciseActivityRiskId == id);
        ...
        {
            return _context.ExerciseActivityRisk.Any(e => e.ExerciseActivityRiskId == id);
        }
    }
}
