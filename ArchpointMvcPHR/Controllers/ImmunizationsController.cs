...
namespace ArchpointMvcPHR.Controllers
{
    ...
    public class ImmunizationsController : Controller
    {
        ...
        public ImmunizationsController(ArchpointMvcPHRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var immunizations = await _context.Immunizations
                .FirstOrDefaultAsync(m => m.ImmunizationsId == id);
        ...
        {
            return _context.Immunizations.Any(e => e.ImmunizationsId == id);
        }
    }
}
