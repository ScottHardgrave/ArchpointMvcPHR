...
{
    public class CNHREmploymentsController : Controller
    {
        private readonly ArchpointMvcPHRContext _context;

        public CNHREmploymentsController(ArchpointMvcPHRContext context)
        {
            _context = context;
        }
        ...
        // GET: CNHREmployments/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CNHREmployments/Create
